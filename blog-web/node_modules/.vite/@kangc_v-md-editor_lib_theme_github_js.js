...
var require_github = __commonJS({
  "node_modules/@kangc/v-md-editor/lib/theme/github.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define("VMdTheme", [], t) : typeof exports == "object" ? exports.VMdTheme = t() : e.VMdTheme = t();
      ...
      return function(e) {
        ...
        e.exports = function(e2, t2, r2, n2) {
          ...
          if (e2.listIndent >= 0 && e2.sCount[t2] - e2.listIndent >= 4 && e2.sCount[t2] < e2.blkIndent)
            return false;
          if (n2 && e2.parentType === "paragraph" && e2.sCount[t2] >= e2.blkIndent && (I = true), (q = i(e2, t2)) >= 0) {
            if (h = true, F = e2.bMarks[t2] + e2.tShift[t2], b = Number(e2.src.slice(F, q - 1)), I && b !== 1)
              return false;
          } else {
            if (!((q = s(e2, t2)) >= 0))
              return false;
        ...
        e.exports = function(e2, t2) {
          var r2, s, i, o = e2.pos;
          if (e2.src.charCodeAt(o) !== 10)
            return false;
          if (r2 = e2.pending.length - 1, s = e2.posMax, !t2)
            if (r2 >= 0 && e2.pending.charCodeAt(r2) === 32)
              if (r2 >= 1 && e2.pending.charCodeAt(r2 - 1) === 32) {
                for (i = r2 - 1; i >= 1 && e2.pending.charCodeAt(i - 1) === 32; )
                  i--;
